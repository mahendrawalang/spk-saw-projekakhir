              ...
              <form action="<?php echo base_url('siswa/ubah') ?>" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nis" class="form-control form-control-sm" placeholder="Nomor Induk Siswa (NIS)" required value="<?php echo $data['nis'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="inputSmall" class="col-form-label">Nama</label>
                    <input type="text" name="nama" class="form-control form-control-sm" placeholder="Nama Lengkap" required value="<?php echo $data['nama'] ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="kelas" class="form-control form-control-sm" placeholder="Kelas" list="daftarkelas" required value="<?php echo $data['kelas'] ?>">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control form-control-sm" name="alamat" rows="3" style="resize: none;" required><?php echo $data['alamat'] ?></textarea>
                  </div>
                </div>
