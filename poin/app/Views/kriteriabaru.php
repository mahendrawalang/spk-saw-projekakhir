              ...
              <form action="<?php echo base_url('kriteria/simpan') ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="kriteria" class="form-control form-control-sm" placeholder="Nama Kriteria" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="bobot" class="form-control form-control-sm" min="1" max="100" value="1" placeholder="Bobot Kriteria" required>
                  </div>
                </div>
