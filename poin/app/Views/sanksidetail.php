    ...
    <div class="dashboard-wrapper">
      <div class="container-fluid dashboard-content">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
              <form action="<?php echo base_url('sanksi/ubah') ?>" method="post">
                <input type="hidden" name="id" value="<?php echo $data['idsanksi'] ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputSmall" class="col-form-label">Sanksi</label>
                    <textarea class="form-control form-control-sm" name="sanksi" placeholder="Jenis atau Kategori Sanksi Pelanggaran" rows="3" style="resize: none;" required><?php echo $data['sanksi'] ?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="inputSmall" class="col-form-label">Poin</label>
                    <input type="number" name="poin" class="form-control form-control-sm" min="1" max="100" value="<?php echo $data['poin'] ?>" placeholder="Batas Maksimal Poin Pelanggaran" required>
                  </div>
                </div>
