      ...
      <div class="container-fluid dashboard-content">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-body">
                <a href="<?php echo base_url('indikator/baru') ?>" class="btn btn-space btn-primary btn-sm" style="float: right;">Tambah Data</a>
                      ...
                      <?php if(count($data) > 0){ ?>
                        <?php foreach ($data as $d) {?>
                          <tr>
                            ...
                            <td><a href="<?php echo base_url('indikator/detail/'.$d['idindikator']) ?>" class="btn btn-space btn-warning btn-xs">Detail</a></td>
                          </tr>
                        <?php } ?>
                      <?php }else{ ?>
                        <tr>
